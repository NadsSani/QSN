...
import com.whytecreations.qsn.databinding.CarListCardsBinding
import com.whytecreations.qsn.ui.auctionlist.auctiondataclass.AuctionDataclass

class CarListAdapter(context: Context, ls:ArrayList<AuctionDataclass>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ViewHolder(view:CarListCardsBinding) : RecyclerView.ViewHolder(view.root){
...
//            .inflate(R.layout.cards_for_list, parent, false)
        val cardsForListBinding = CarListCardsBinding.inflate(view,parent,false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener{
            it.findNavController().navigate(R.id.carDetailsPage)
        }
