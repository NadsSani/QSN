...
import com.whytecreations.qsn.databinding.FragmentOTPBinding
...
class OTP : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentOTPBinding = DataBindingUtil.inflate(
            inflater,R.layout.fragment_o_t_p,container,false)
        binding.lifecycleOwner = viewLifecycleOwner
        binding.verifyotp.setOnClickListener{
            findNavController().navigate(R.id.createPassword)
        }
        return binding.root
    }
