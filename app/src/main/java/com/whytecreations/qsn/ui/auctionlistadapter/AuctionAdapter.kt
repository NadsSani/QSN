...
class AuctionAdapter(context: Context, ls:ArrayList<AuctionDataclass>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):RecyclerView.ViewHolder {
       if(viewType == item_viewtype){
           return ViewHolder(LayoutInflater.from(context).inflate(
               R.layout.auction_cardview,parent,false))
       }else{
           return ViewHolder2(LayoutInflater.from(context).inflate(
               R.layout.auctioncardview2,parent,false))
